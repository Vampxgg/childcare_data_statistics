...
def main():
    ...
    yaml_file = workspace_dir / "托育 - 产业分析智能体(ceshi).yml"
    ...
    print("\n导入完成！")
    print(f"- 代码节点: {len(code_files)} 个")
    print(f"- Agent 节点: {len(agent_files)} 个")
    print(f"- Prompt 节点: {len(prompt_files)} 个")
    print(f"- 模板节点: {len(template_files)} 个")
    print(f"- 文档已生成: README.md, docs/workflow_structure.md")
