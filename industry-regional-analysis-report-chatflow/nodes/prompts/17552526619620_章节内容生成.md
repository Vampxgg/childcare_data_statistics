...
       {
         "index": 3,
         "name": "/* copy from institution_info.name */",
         "credit_code": "/* copy from institution_info.credit_code */",
         "type": "/* copy from institution_info.type */",
         "address": "/* copy from institution_info.address */",
         "region_code": "/* copy from institution_info.region_code */"
       }
    ],
    "questionnaire": [
       {
         "index": 5,
         "institution_name": "/* copy from institution_info.name */",
         "subject_type": "/* copy from institution_info.subject_type */",
         "service_modes": ["全日托"],
         "total_capacity": 60,
         "position": "/* copy from employment_info.current_position */",
         "salary_range": "/* copy from employment_info.salary_range */"
       }
    ],
    "postData": [
       {
...
`{{level}}`:{{#1754636636322.level#}}
`{{Step}}`:{{#1754672700464.output_object#}}
`{{templateAnalysisSteps}}` :{{#conversation.templateAnalysisSteps#}}
`{{web_data}}`:{{#1755056952703.data#}}
```
